export const specialLettersArray = [
  ...
  ['ArrowUp', 54, '&#8593', emptyFunction, emptyFunction, '40px'],
  ...
  ['Space', 59, '&#160', emptyFunction, emptyFunction, '320px'],
  ['AltRight', 60, 'ALT', emptyFunction, emptyFunction, '40px'],
  ['ControlRight', 61, 'CTRL', emptyFunction, emptyFunction, '40px'],
  ['ArrowLeft', 62, '&#8592', emptyFunction, emptyFunction, '40px'],
  ['ArrowDown', 63, '&#8595', emptyFunction, emptyFunction, '40px'],
  ['ArrowRight', 64, '&#8594', emptyFunction, emptyFunction, '40px']
];
